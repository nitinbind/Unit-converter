...
unit[0] = new Array("Degrees Celsius (°C)", "Degrees Fahrenheit (°F)", "Degrees Kelvin (°K)", "Degrees Rankine (°R)");
factor[0] = new Array(1, 0.555555555555, 1, 0.555555555555);
tempIncrement = new Array(0, -32, -273.15, -491.67);


property[14] = "Acceleration";
unit[14] = new Array("Meter/sq.sec (m/sec²)", "Foot/sq.sec (ft/sec²)", "G (g)", "Galileo (gal)", "Inch/sq.sec (in/sec²)");
factor[14] = new Array(1, .3048, 9.806650, .01, 2.54E-02);

property[1] = "Area";
unit[1] = new Array("Square meter (m²)", "Acre (acre)", "Are", "Barn (barn)", "Hectare", "Rood", "Square centimeter", "Square kilometer", "Circular mil", "Square foot (ft²)", "Square inch (in²)", "Square mile (mi²)", "Square yard (yd²)");
